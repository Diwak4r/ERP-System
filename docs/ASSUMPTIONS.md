...
## Realtime Requisition Pop-up Alerts

- The current RBAC model has no separate `STORE_MANAGER` role; real-time approval pop-up alerts are shown to `ADMIN` users, who own requisition approval actions.
